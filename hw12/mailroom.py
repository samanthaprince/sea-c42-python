# Mailroom file for homework 12 - Update mailroom h
...
# def order_dict():
    # for key in donor_list:
        ...
        # new_donor_list.update({donor_name: total_donated})
        # return new_donor_list


# sort_donor_list = OrderedDict(sorted(new_donor_list.items(), key=lambda x: x[1]))
